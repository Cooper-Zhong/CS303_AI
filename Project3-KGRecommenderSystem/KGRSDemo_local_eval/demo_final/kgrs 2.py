...
class KGRS:
    def __init__(self, train_pos: np.array, train_neg: np.array, kg_lines: List[str]):
        ...
        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 256, "l1": False, "margin": 15,
        #   "learning_rate": 1e-4, "weight_decay": 0, "epoch_num": 30}
        # 0.669, 0.012

        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 128, "l1": True, "margin": 15,
        #           "learning_rate": 1e-3, "weight_decay": 0, "epoch_num": 30}
        # 0.743, 0.023

        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 64, "l1": True, "margin": 15,
        #           "learning_rate": 1e-3, "weight_decay": 0, "epoch_num": 25}  # epoch_num = 35 会降
        # # 0.788, 0.035

        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 64, "l1": True, "margin": 15,
        #           "learning_rate": 1e-3, "weight_decay": 0, "epoch_num": 20}
        # # 0.769, 0.04
        ...
        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 16, "l1": True, "margin": 15,
        #           "learning_rate": 0.003, "weight_decay": 0, "epoch_num": 20}  # 不能再降emb_dim了
        # # 0.83, 0.058

        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 16, "l1": True, "margin": 15,
        #           "learning_rate": 0.003, "weight_decay": 1e-4, "epoch_num": 20} 
        # # 0.859, 0.076

        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 16, "l1": True, "margin": 15,
        #           "learning_rate": 0.003, "weight_decay": 1e-4, "epoch_num": 30}  
        # # 0.87, 0.081

        # config = {"batch_size": 256, "eval_batch_size": 1024, "neg_rate": 2, "emb_dim": 16, "l1": True, "margin": 15,
        #           "learning_rate": 0.003, "weight_decay": 1e-3, "epoch_num": 25} 
        # # 0.85, 0.0928
